...
class MyScene(Scene):
	def setup(self):
		...
		node0.backgroundColor = Color(0,0,0,1.0)
		node0.anchorPoint = Point(0.5,0.5)
		self.addChild(node0, 20)

		self.node1 = Node(MakeRect(170,150,100,250))
		self.node1.backgroundColor = BlueColor()
		self.node1.anchorPoint = Point(0.0,0.5)
		self.node1.scale = 0.5
		...
		node4.backgroundColor = Color(1.0, 0.0, 0.0, 0.5)
		self.node3.addChild(node4,1)

		node2 = Node(MakeRect(50, 75, 200, 100))
		node2.backgroundColor = GreenColor()
